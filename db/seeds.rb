...
pet_photos.each do |photo|
  pet = Pet.new(user: userone, name: Faker::Creature::Animal.name, description: Faker::Creature::Bird.emotional_adjective, price: rand(1..5))
  file = URI.open(photo)
...
pet_photos_two.each do |photo|
  pet_one = Pet.new(user: usertwo, name: Faker::Creature::Animal.name, description: Faker::Creature::Bird.emotional_adjective, price: rand(1..5))
  file = URI.open(photo)
...
pet_photos_three.each do |photo|
  pet_two = Pet.new(user: userthree, name: Faker::Creature::Animal.name, description: Faker::Creature::Bird.emotional_adjective, price: rand(1..5))
  file = URI.open(photo)
